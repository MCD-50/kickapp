...
class ComminicationEmailUI extends React.Component {
	constructor(props) {
		super(props);
		...
		if (props.currentMessage && props.position.toString() == 'left') {
			return (
				<View>
					...
					<Text style={[styles[props.position].text, props.textStyle[props.position]]}>
						{this.capitalize(props.currentMessage.communication.from_email)}
					</Text>
				</View>
			);
		}
	...
	render() {
		...
		return (
			<View style={[styles[this.props.position].container, this.props.containerStyle[this.props.position]]}
				onPress={this.onRespond(this.props.currentMessage)}>
				{
...
ComminicationEmailUI.propTypes = propTypes;
ComminicationEmailUI.defaultProps = defaultProps;
ComminicationEmailUI.contextTypes = contextTypes;

export default ComminicationEmailUI;